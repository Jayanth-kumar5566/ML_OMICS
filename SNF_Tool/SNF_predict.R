...
#b_data=read.csv("Data/SMOTE/bacteria_smoted.csv")
b_data=read.csv("Data/bacteria.csv")
#f_data=read.csv("Data/SMOTE/fungi_smoted.csv")
f_data=read.csv("Data/fungi.csv")
#l=read.csv("Data/SMOTE/DM_CM_smoted.csv")
l=read.csv("Data/DM_CM.csv")
label=c(l$exacgrp)
