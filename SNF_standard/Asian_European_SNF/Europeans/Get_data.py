...
df3=pandas.read_csv("../../../Demographics.1.csv")
...
l_data=l_data[["Asian_European"]]
b_data=b_data.merge(l_data,how='left',on="PatientID")
f_data=f_data.merge(l_data,how='left',on="PatientID")

#l_data.dropna(axis=0,how="any",inplace=True)
b_data=b_data[b_data.Asian_European=="European"]
f_data=f_data[f_data.Asian_European=="European"]
