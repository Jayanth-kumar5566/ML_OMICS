#Combining the data
data1=read.csv("Documents/MS/ML_OMICS/SNF_4/Cluster_eval/Luminex/Lu_SA_RA.csv")
data2=read.csv("Documents/MS/ML_OMICS/SNF_4/Cluster_eval/Luminex/labels.csv")
...
if (t$p.value <= 0.05){
  print(i)
  png(paste("./Documents/MS/ML_OMICS/SNF_4/Cluster_eval/Luminex/",i,".png",sep=''))
  boxplot(p1,p2,p3,p4,xlab=i)
  dev.off()
  #print(shapiro.test(p1)$p.value)
